...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/saltcoats/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/saltcoats/pressure-washing",
  ...
  },
  {
    ...
    path: "/saltcoats/gutter-cleaning",
  ...
  },
  {
    ...
    path: "/saltcoats/conservatory-cleaning",
...
export const SaltcoatsServicesGrid = () => {
  return (
