...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/hamilton/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/hamilton/pressure-washing",
  ...
  },
  {
    ...
    path: "/hamilton/conservatory-cleaning",
...
export const HamiltonServicesGrid = () => {
  return (
