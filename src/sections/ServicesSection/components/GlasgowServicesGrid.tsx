...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/glasgow/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/glasgow/conservatory-cleaning",
...
export const GlasgowServicesGrid = () => {
  return (
