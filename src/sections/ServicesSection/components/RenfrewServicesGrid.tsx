...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/renfrew/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/renfrew/conservatory-cleaning",
...
export const RenfrewServicesGrid = () => {
  return (
