...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/ardrossan/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/ardrossan/pressure-washing",
  ...
  },
  {
    ...
    path: "/ardrossan/gutter-cleaning",
  ...
  },
  {
    ...
    path: "/ardrossan/conservatory-cleaning",
...
export const ArdrossanServicesGrid = () => {
  return (
