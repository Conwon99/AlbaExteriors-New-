...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/edinburgh/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/edinburgh/pressure-washing",
  ...
  },
  {
    ...
    path: "/edinburgh/gutter-cleaning",
  ...
  },
  {
    ...
    path: "/edinburgh/conservatory-cleaning",
...
export const EdinburghServicesGrid = () => {
  return (
