...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/airdrie/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/airdrie/conservatory-cleaning",
...
export const AirdrieServicesGrid = () => {
  return (
