...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/johnstone/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/johnstone/pressure-washing",
  ...
  },
  {
    ...
    path: "/johnstone/gutter-cleaning",
  ...
  },
  {
    ...
    path: "/johnstone/conservatory-cleaning",
...
export const JohnstoneServicesGrid = () => {
  return (
