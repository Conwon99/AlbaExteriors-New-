...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/paisley/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/paisley/conservatory-cleaning",
...
export const PaisleyServicesGrid = () => {
  return (
