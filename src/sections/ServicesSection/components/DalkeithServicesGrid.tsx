...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/dalkeith/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/dalkeith/pressure-washing",
  ...
  },
  {
    ...
    path: "/dalkeith/conservatory-cleaning",
...
export const DalkeithServicesGrid = () => {
  return (
