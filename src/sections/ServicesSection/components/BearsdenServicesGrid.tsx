...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/bearsden/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/bearsden/pressure-washing",
  ...
  },
  {
    ...
    path: "/bearsden/conservatory-cleaning",
...
export const BearsdenServicesGrid = () => {
  return (
