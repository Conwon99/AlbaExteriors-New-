...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/bathgate/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/bathgate/pressure-washing",
  ...
  },
  {
    ...
    path: "/bathgate/conservatory-cleaning",
...
export const BathgateServicesGrid = () => {
  return (
