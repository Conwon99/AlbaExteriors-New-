...
const services: ServiceGridItem[] = [
  ...
  },
  {
    ...
    path: "/bonnyrigg/driveway-cleaning",
  ...
  },
  {
    ...
    path: "/bonnyrigg/pressure-washing",
  ...
  },
  {
    ...
    path: "/bonnyrigg/gutter-cleaning",
  ...
  },
  {
    ...
    path: "/bonnyrigg/conservatory-cleaning",
...
export const BonnyriggServicesGrid = () => {
  return (
