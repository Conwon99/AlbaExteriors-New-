...
export const BeforeAfterSection = ({ 
  beforeImage = "/beforealba.jpeg",
  afterImage = "/afteralba.jpeg",
  title = "Before & After",
  subtitle = "Alba Exteriors"
        ...
        <div className="text-sm box-border caret-transparent flex justify-center leading-[20.3px] break-words md:text-[17px] md:leading-[24.65px]">
          ...
          >
            ...
            <div
              ...
              style={{
                backgroundImage: `url('${encodeURI(beforeImage)}')`,
              }}
            />
            ...
            <div
              ...
              style={{
                backgroundImage: `url('${encodeURI(afterImage)}')`,
